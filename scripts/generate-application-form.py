...
T = {
    'en': dict(
        ...
        cat_opts=['Research Fellow', 'Associate Research Fellow', 'Research Assistant', 'Young Research Fellow', 'Visiting Research Fellow', 'Part-time Research Fellow', 'Distinguished Research Fellow', 'Undergraduate Research Intern', 'Other'],
        ...
        center_opts=['Scholarly Publishing Studies', 'Journal Indexing & Evaluation', 'Public Policy & Social Research', 'AI & Future Society', 'Education & Learning Research', 'Arts, Culture & Embodiment', 'Health & Medical Research', 'International & Regional Studies', 'Digital & Platform Governance', 'Youth Issues & Social Development', 'Other'],
        ...
        reccenter_label='Recommended area / center', reccenter_opts=['Scholarly Publishing Studies', 'Journal Indexing & Evaluation', 'Public Policy & Social Research', 'AI & Future Society', 'Arts, Culture & Embodiment', 'Health & Medical Research', 'To be determined'],
...
T['zh-cn'] = dict(
    ...
    cat_label='申请类别',
    cat_opts=['研究员', '副研究员', '研究助理', '青年研究员', '访问研究员', '兼职研究员', '特聘研究员', '本科生研究实习生', '其他'],
    ...
    center_opts=['学术出版研究', '期刊索引与评价研究', '公共政策与社会研究', '人工智能与未来社会', '教育与学习研究', '艺术、文化与具身研究', '健康与医学研究', '国际关系与区域研究', '数字治理与平台治理', '青年议题与社会发展', '其他'],
    ...
    reccenter_label='建议归属研究方向 / 研究中心', reccenter_opts=['学术出版研究', '期刊索引与评价研究', '公共政策与社会研究', '人工智能与未来社会', '艺术、文化与具身研究', '健康与医学研究', '暂不指定'],
...
T['zh-tw'] = dict(
    ...
    cat_label='申請類別',
    cat_opts=['研究員', '副研究員', '研究助理', '青年研究員', '訪問研究員', '兼職研究員', '特聘研究員', '本科生研究實習生', '其他'],
    ...
    center_opts=['學術出版研究', '期刊索引與評價研究', '公共政策與社會研究', '人工智慧與未來社會', '教育與學習研究', '藝術、文化與具身研究', '健康與醫學研究', '國際關係與區域研究', '數位治理與平台治理', '青年議題與社會發展', '其他'],
    ...
    reccenter_label='建議歸屬研究方向 / 研究中心', reccenter_opts=['學術出版研究', '期刊索引與評價研究', '公共政策與社會研究', '人工智慧與未來社會', '藝術、文化與具身研究', '健康與醫學研究', '暫不指定'],
