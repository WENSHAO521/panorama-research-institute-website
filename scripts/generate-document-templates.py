...
# 7. Edited Volume Proposal Template ------------------------------------------
TEMPLATES.append({
    ...
    'meta': lambda lang: [
        ...
        (L['version'][lang], L['version_v'][lang]),
        ({'en': 'Typical Length', 'zh-cn': '一般篇幅', 'zh-tw': '一般篇幅'}[lang],
         {'en': 'Up to 2,000 words + chapter list', 'zh-cn': '最多 2,000 字 + 章节清单', 'zh-tw': '最多 2,000 字 + 章節清單'}[lang]),
        (L['submission_lang'][lang], L['submission_lang_v'][lang]),
    ],
    'intro': {
        'en': 'This template is used to prepare a proposal to edit an academic volume in association with Panorama Research Institute. Complete all seven sections below, then attach this document to the Edited Volume Proposal form at research.panorama-sg.com/collaboration/edited-volume-proposal, or submit it by email to publications@panorama-sg.com.',
        'zh-cn': '本模板用于准备与全景研究院合作主编学术文集的提案。请完整填写以下七个部分，然后在主编文集提案表单（research.panorama-sg.com/zh-cn/collaboration/edited-volume-proposal）中附上本文档，或通过电子邮件发送至 publications@panorama-sg.com。',
        'zh-tw': '本範本用於準備與全景研究院合作主編學術文集的提案。請完整填寫以下七個部分，然後在主編文集提案表單（research.panorama-sg.com/zh-tw/collaboration/edited-volume-proposal）中附上本文件，或透過電子郵件傳送至 publications@panorama-sg.com。',
    },
    'sections': lambda lang: [
        (
            {'en': 'Cover Page', 'zh-cn': '封面', 'zh-tw': '封面'}[lang],
            {'en': 'Working volume title, lead editor details, submission date.',
             'zh-cn': '文集暂定标题、主编信息、提交日期。',
             'zh-tw': '文集暫定標題、主編資訊、提交日期。'}[lang],
            {'en': '[Working Volume Title]\n[Lead Editor Name, Affiliation]\n[Submission Date]',
             'zh-cn': '［文集暂定标题］\n［主编姓名、所属机构］\n［提交日期］',
             'zh-tw': '［文集暫定標題］\n［主編姓名、所屬機構］\n［提交日期］'}[lang],
        ),
        (
            {'en': '1. Volume Title and Synopsis', 'zh-cn': '一、文集标题与概要', 'zh-tw': '一、文集標題與概要'}[lang],
            {'en': 'Working title and a 300-word synopsis of the volume’s scope and significance.',
             'zh-cn': '文集暂定标题，以及 300 词范围与意义概要。',
             'zh-tw': '文集暫定標題，以及 300 詞範圍與意義概要。'}[lang],
            {'en': '[Insert the working title and a 300-word synopsis describing the volume’s scope, theme, and scholarly significance.]',
             'zh-cn': '［请填写文集暂定标题，并以约 300 字概述文集的范围、主题及学术意义。］',
             'zh-tw': '［請填寫文集暫定標題，並以約 300 字概述文集的範圍、主題及學術意義。］'}[lang],
        ),
        (
            {'en': '2. Editor(s) Profile', 'zh-cn': '二、主编简介', 'zh-tw': '二、主編簡介'}[lang],
            {'en': 'Academic bio and relevant publications of the proposed volume editor(s).',
             'zh-cn': '拟任文集主编的学术简介与相关出版物。',
             'zh-tw': '擬任文集主編的學術簡介與相關出版物。'}[lang],
            {'en': '[Insert the academic biography and relevant publications of each proposed volume editor.]',
             'zh-cn': '［请填写每位拟任文集主编的学术简介及相关出版物。］',
             'zh-tw': '［請填寫每位擬任文集主編的學術簡介及相關出版物。］'}[lang],
        ),
        (
            {'en': '3. Target Audience', 'zh-cn': '三、目标读者', 'zh-tw': '三、目標讀者'}[lang],
            {'en': 'Primary and secondary readership for the volume.',
             'zh-cn': '文集的主要和次要读者群。',
             'zh-tw': '文集的主要和次要讀者群。'}[lang],
            {'en': '[Describe the primary and secondary readership this volume is intended for.]',
             'zh-cn': '［请描述本文集面向的主要与次要读者群体。］',
             'zh-tw': '［請描述本文集面向的主要與次要讀者群體。］'}[lang],
        ),
        (
            {'en': '4. Proposed Chapter Structure', 'zh-cn': '四、拟定章节结构', 'zh-tw': '四、擬定章節結構'}[lang],
            {'en': 'Provisional chapter list with working titles and 50-word abstracts.',
             'zh-cn': '含暂定标题和 50 词摘要的临时章节清单。',
             'zh-tw': '含暫定標題和 50 詞摘要的臨時章節清單。'}[lang],
            {'en': '[Chapter 1: Working title — 50-word abstract]\n[Chapter 2: Working title — 50-word abstract]\n\n(Add a line for each provisional chapter.)',
             'zh-cn': '［第一章：暂定标题——50 字摘要］\n［第二章：暂定标题——50 字摘要］\n\n（如有更多章节，请逐一列出。）',
             'zh-tw': '［第一章：暫定標題——50 字摘要］\n［第二章：暫定標題——50 字摘要］\n\n（如有更多章節，請逐一列出。）'}[lang],
        ),
        (
            {'en': '5. Proposed Publisher', 'zh-cn': '五、拟合作出版社', 'zh-tw': '五、擬合作出版社'}[lang],
            {'en': 'Target publisher or publishers, with any existing discussions noted.',
             'zh-cn': '目标出版社，并说明已有沟通情况。',
             'zh-tw': '目標出版社，並說明已有溝通情況。'}[lang],
            {'en': '[Name the target publisher(s) and note the status of any existing discussions.]',
             'zh-cn': '［请列出目标出版社，并说明目前的沟通进展（如有）。］',
             'zh-tw': '［請列出目標出版社，並說明目前的溝通進展（如有）。］'}[lang],
        ),
        (
            {'en': '6. Timeline', 'zh-cn': '六、时间表', 'zh-tw': '六、時間表'}[lang],
            {'en': 'Proposed call for chapters, submission, and publication timeline.',
             'zh-cn': '拟定章节征集、投稿和出版时间表。',
             'zh-tw': '擬定章節徵集、投稿和出版時間表。'}[lang],
            {'en': '[Call for Chapters: date]\n[Chapter Submission Deadline: date]\n[Expected Publication: date]',
             'zh-cn': '［章节征集发布：日期］\n［章节投稿截止：日期］\n［预计出版：日期］',
             'zh-tw': '［章節徵集發布：日期］\n［章節投稿截止：日期］\n［預計出版：日期］'}[lang],
        ),
        (
            {'en': '7. Open Access Plan', 'zh-cn': '七、开放获取计划', 'zh-tw': '七、開放取用計畫'}[lang],
            {'en': 'Proposed open access model and any existing APC funding.',
             'zh-cn': '拟定开放获取模式及已有 APC 经费。',
             'zh-tw': '擬定開放取用模式及已有 APC 經費。'}[lang],
            {'en': '[Describe the proposed open access model (e.g., gold, green, diamond) and any secured or anticipated Article Processing Charge (APC) funding.]',
             'zh-cn': '［请说明拟采用的开放获取模式（如金色、绿色、钻石开放获取）及已获得或预期的 APC（文章处理费）资助情况。］',
             'zh-tw': '［請說明擬採用的開放取用模式（如金色、綠色、鑽石開放取用）及已獲得或預期的 APC（文章處理費）資助情況。］'}[lang],
        ),
    ],
})

# 8. Special Issue Proposal Template ------------------------------------------
TEMPLATES.append({
    ...
    'meta': lambda lang: [
        ...
        (L['version'][lang], L['version_v'][lang]),
        ({'en': 'Typical Length', 'zh-cn': '一般篇幅', 'zh-tw': '一般篇幅'}[lang],
         {'en': 'Up to 1,500 words', 'zh-cn': '最多 1,500 字', 'zh-tw': '最多 1,500 字'}[lang]),
        (L['submission_lang'][lang], L['submission_lang_v'][lang]),
    ],
    'intro': {
        'en': 'This template is used to prepare a proposal for a special issue of an academic journal, organized and guest-edited in association with Panorama Research Institute. Complete all seven items below, then attach this document to the Special Issue Proposal form at research.panorama-sg.com/collaboration/special-issue-proposal, or submit it by email to publications@panorama-sg.com.',
        'zh-cn': '本模板用于准备与全景研究院合作组织并担任客座编辑的期刊特刊提案。请完整填写以下七项内容，然后在特刊提案表单（research.panorama-sg.com/zh-cn/collaboration/special-issue-proposal）中附上本文档，或通过电子邮件发送至 publications@panorama-sg.com。',
        'zh-tw': '本範本用於準備與全景研究院合作組織並擔任客座編輯的期刊特刊提案。請完整填寫以下七項內容，然後在特刊提案表單（research.panorama-sg.com/zh-tw/collaboration/special-issue-proposal）中附上本文件，或透過電子郵件傳送至 publications@panorama-sg.com。',
    },
    'sections': lambda lang: [
        (
            {'en': 'Cover Page', 'zh-cn': '封面', 'zh-tw': '封面'}[lang],
            {'en': 'Special issue working title, guest editor details, target journal, submission date.',
             'zh-cn': '特刊暂定标题、客座编辑信息、目标期刊、提交日期。',
             'zh-tw': '特刊暫定標題、客座編輯資訊、目標期刊、提交日期。'}[lang],
            {'en': '[Special Issue Working Title]\n[Guest Editor Name, Affiliation]\n[Target Journal]\n[Submission Date]',
             'zh-cn': '［特刊暂定标题］\n［客座编辑姓名、所属机构］\n［目标期刊］\n［提交日期］',
             'zh-tw': '［特刊暫定標題］\n［客座編輯姓名、所屬機構］\n［目標期刊］\n［提交日期］'}[lang],
        ),
        (
            {'en': '1. Title and Description', 'zh-cn': '一、标题与说明', 'zh-tw': '一、標題與說明'}[lang],
            {'en': 'Title and a 200-word description of the special issue theme.',
             'zh-cn': '特刊主题标题及 200 词说明。',
             'zh-tw': '特刊主題標題及 200 詞說明。'}[lang],
            {'en': '[Insert the special issue title and a 200-word description of its theme and scope.]',
             'zh-cn': '［请填写特刊主题标题，并以约 200 字说明其主题与范围。］',
             'zh-tw': '［請填寫特刊主題標題，並以約 200 字說明其主題與範圍。］'}[lang],
        ),
        (
            {'en': '2. Target Journal', 'zh-cn': '二、目标期刊', 'zh-tw': '二、目標期刊'}[lang],
            {'en': 'Target journal and the reason for selecting it.',
             'zh-cn': '目标期刊及选择理由。',
             'zh-tw': '目標期刊及選擇理由。'}[lang],
            {'en': '[Name the target journal and explain why it is well suited to this special issue.]',
             'zh-cn': '［请填写目标期刊名称，并说明选择该期刊的理由。］',
             'zh-tw': '［請填寫目標期刊名稱，並說明選擇該期刊的理由。］'}[lang],
        ),
        (
            {'en': '3. Journal Engagement Status', 'zh-cn': '三、期刊沟通状态', 'zh-tw': '三、期刊溝通狀態'}[lang],
            {'en': 'Status of journal engagement (inquired, in discussion, approved).',
             'zh-cn': '期刊沟通状态（已咨询、讨论中、已批准）。',
             'zh-tw': '期刊溝通狀態（已諮詢、討論中、已批准）。'}[lang],
            {'en': '[State the current status of engagement with the target journal: inquired, in discussion, or approved.]',
             'zh-cn': '［请说明与目标期刊沟通的现状：已咨询、讨论中，或已获批准。］',
             'zh-tw': '［請說明與目標期刊溝通的現狀：已諮詢、討論中，或已獲批准。］'}[lang],
        ),
        (
            {'en': '4. Guest Editor(s) Profile', 'zh-cn': '四、客座编辑简介', 'zh-tw': '四、客座編輯簡介'}[lang],
            {'en': 'Guest editor(s) profile and relevant expertise.',
             'zh-cn': '客座编辑简介及相关专长。',
             'zh-tw': '客座編輯簡介及相關專長。'}[lang],
            {'en': '[Insert the profile and relevant expertise of each proposed guest editor.]',
             'zh-cn': '［请填写每位拟任客座编辑的简介及相关专长。］',
             'zh-tw': '［請填寫每位擬任客座編輯的簡介及相關專長。］'}[lang],
        ),
        (
            {'en': '5. Provisional Paper Topics', 'zh-cn': '五、临时论文主题', 'zh-tw': '五、臨時論文主題'}[lang],
            {'en': 'Provisional list of 4–8 paper topics or expected contributors.',
             'zh-cn': '4–8 个论文主题或预期作者临时清单。',
             'zh-tw': '4–8 個論文主題或預期作者臨時清單。'}[lang],
            {'en': '[Topic 1 / expected contributor]\n[Topic 2 / expected contributor]\n\n(List 4–8 provisional paper topics or expected contributors.)',
             'zh-cn': '［主题一／预期作者］\n［主题二／预期作者］\n\n（请列出 4–8 个临时论文主题或预期作者。）',
             'zh-tw': '［主題一／預期作者］\n［主題二／預期作者］\n\n（請列出 4–8 個臨時論文主題或預期作者。）'}[lang],
        ),
        (
            {'en': '6. Call for Papers Timeline', 'zh-cn': '六、征稿时间表', 'zh-tw': '六、徵稿時間表'}[lang],
            {'en': 'Proposed call for papers timeline and submission deadline.',
             'zh-cn': '拟议征稿时间表和投稿截止日期。',
             'zh-tw': '擬議徵稿時間表和投稿截止日期。'}[lang],
            {'en': '[Call for Papers: date]\n[Submission Deadline: date]\n[Peer Review Period: date range]',
             'zh-cn': '［征稿发布：日期］\n［投稿截止：日期］\n［同行评审周期：日期区间］',
             'zh-tw': '［徵稿發布：日期］\n［投稿截止：日期］\n［同行評審週期：日期區間］'}[lang],
        ),
        (
            {'en': '7. Proposed Publication Date', 'zh-cn': '七、拟议出版日期', 'zh-tw': '七、擬議出版日期'}[lang],
            {'en': 'Proposed publication date for the special issue.',
             'zh-cn': '特刊拟议出版日期。',
             'zh-tw': '特刊擬議出版日期。'}[lang],
            {'en': '[Insert the proposed publication date for the special issue.]',
             'zh-cn': '［请填写特刊的拟议出版日期。］',
             'zh-tw': '［請填寫特刊的擬議出版日期。］'}[lang],
        ),
    ],
})
